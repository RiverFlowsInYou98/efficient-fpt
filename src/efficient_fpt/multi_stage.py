...
def get_multistage_densities(t_grid, mu_array, sacc_array, sigma_array, a1, b1_array, a2, b2_array, T, x0, order=20, eps=1e-3, trunc_num=100, threshold=1e-20, fixed_terms=False):
    """
