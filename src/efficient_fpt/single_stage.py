...
def fptd_single(t, mu, sigma, a1, b1, a2, b2, x0, bdy, trunc_num=100, threshold=1e-20):
    ...
    a2 = (a2 - x0) / sigma
    b2 = b2 / sigma
    return fptd_basic(t, mu, a1, b1, a2, b2, bdy, trunc_num, threshold)


def q_single(x, mu, sigma, a1, b1, a2, b2, T, x0, trunc_num=100, threshold=1e-20):
    x = (x - x0) / sigma
    mu = mu / sigma
    a1 = (a1 - x0) / sigma
    b1 = b1 / sigma
    a2 = (a2 - x0) / sigma
    b2 = b2 / sigma
    return q_basic(x, mu, a1, b1, a2, b2, T, trunc_num, threshold) / sigma
